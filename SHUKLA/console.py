...
SUDO_USERS = list(map(int, getenv("SUDO_USERS", "6283192619").split()))
ALIVE_PIC = getenv("ALIVE_PIC", "https://files.catbox.moe/yvwrge.jpg")
...
USERBOT_PICTURE = getenv("USERBOT_PICTURE", "https://files.catbox.moe/yvwrge.jpg")
